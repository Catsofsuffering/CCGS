      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-1">
          <button
            onClick={saveEdit}
            disabled={saving}
            className="p-1.5 rounded-md text-accent hover:bg-accent-muted transition-colors disabled:opacity-50"
            title="Save"
          >
  ...
  return (
    <div className="animate-fade-in space-y-8">
      ...
      <section>
        ...
        {error && (
          <div className="mb-4 px-4 py-2.5 bg-gray-500/10 border border-gray-400/30 rounded-lg text-sm text-gray-300">
            {error}
          </div>
        )}
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          disabled={isEditing}
                          className="p-1.5 rounded-md text-gray-400 hover:text-gray-200 hover:bg-surface-4 transition-colors disabled:opacity-30"
                          title="Edit"
                        >
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-3">
              {sysInfo?.hooks.installed ? (
                <span className="inline-flex items-center gap-1.5 text-xs font-medium text-accent bg-accent-muted border border-accent/30 px-2.5 py-1 rounded-full">
                  <CheckCircle className="w-3.5 h-3.5" /> All hooks installed
                </span>
              ) : (
                <span className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-300 bg-gray-500/10 border border-gray-400/30 px-2.5 py-1 rounded-full">
      ...
      <section>
        ...
        <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
                {(() => {
                  const tableIcons: Record<string, React.ReactNode> = {
                    sessions: <Layers className="w-4 h-4 text-gray-400" />,
                    agents: <Users className="w-4 h-4 text-gray-400" />,
                    events: <Activity className="w-4 h-4 text-gray-400" />,
                    token_usage: <Coins className="w-4 h-4 text-gray-400" />,
                    model_pricing: <BarChart3 className="w-4 h-4 text-gray-400" />,
                  };
                  ...
                  const tableColors: Record<string, string> = {
                    sessions: "border-gray-500/20",
                    agents: "border-gray-500/20",
                    events: "border-gray-500/20",
                    token_usage: "border-gray-500/20",
                    model_pricing: "border-gray-500/20",
                  };
                ...
                <div className="bg-surface-2 rounded-lg px-3 py-3 border-l-2 border-gray-500/20">
                  <div className="flex items-center gap-2 mb-1.5">
          ...
          <div className="card p-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-gray-500/10 border border-gray-400/30 flex items-center justify-center">
          ...
          {/* Danger zone */}
          <div className="card p-5 space-y-4 border-gray-500/10">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-gray-500/10 border border-gray-400/30 flex items-center justify-center">
            ...
            {confirmAction === "clear" ? (
              <div className="bg-gray-500/5 border border-gray-400/30 rounded-lg px-4 py-3 flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    disabled={actionLoading !== null}
                    className="text-xs px-3 py-1.5 rounded-md bg-gray-500/20 text-gray-300 border border-gray-400/30 hover:bg-gray-500/30 transition-colors disabled:opacity-50"
                  >
                    {actionLoading === "clear" ? (
              ...
              <button
                ...
                disabled={actionLoading !== null}
                className="text-xs px-3 py-1.5 rounded-md text-gray-300 hover:bg-gray-500/10 border border-gray-400/30 transition-colors disabled:opacity-50"
              >
