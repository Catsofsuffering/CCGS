...
const LEGEND_ITEMS: Array<{ label: string; color: string }> = [
  { label: "Read", color: "#6b7280" },
  { label: "Write", color: "#16a34a" },
  { label: "Edit", color: "#9ca3af" },
  { label: "Bash", color: "#4b5563" },
  { label: "Grep", color: "#374151" },
  { label: "Glob", color: "#6b7280" },
  { label: "Agent", color: "#16a34a" },
