...
const zhCN = {
  ...
  init: {
    ...
    pathWarning: '需要确保 Claude Code CLI 已加入 PATH',
    ...
    mcp: {
      ...
      aceToolRsPaid: '更轻量',
      skipLater: '稍后手动配置',
      skipTokenPrompt: '是否跳过 Token 配置？（可稍后运行 npx ccgs-workflow config mcp 配置）',
      skipKeyPrompt: '是否跳过 API Key 配置？（可稍后运行 npx ccgs-workflow config mcp 配置）',
    ...
    hooks: {
      title: 'Claude monitor Hook 配置',
      description: '使用 Hook 将 Claude 事件发送到本地 monitor',
      installed: 'Hook 已配置（Claude monitor 已接管本地监控）',
    ...
    workflows: {
      dev: '主路径工作流 (/ccgs:spec-impl)',
      frontend: 'OpenSpec 初始化 (/ccgs:spec-init)',
      backend: '需求研究 (/ccgs:spec-research)',
      review: '验收审查 (/ccgs:spec-review)',
      analyze: '执行规划 (/ccgs:team-plan)',
      commit: 'Git 智能提交 (/ccgs:commit)',
      rollback: 'Git 回滚 (/ccgs:rollback)',
      cleanBranches: '清理分支 (/ccgs:clean-branches)',
      worktree: 'Worktree 管理 (/ccgs:worktree)',
      init: '项目初始化 (/ccgs:init)',
    },
    aceTool: {
  ...
  menu: {
    ...
    help: {
      title: 'CCG 命令:',
      hint: '更多信息请运行: npx ccgs-workflow --help',
      sections: {
        devWorkflow: '开发工作流:',
        opsx: 'OpenSpec 规范驱动:',
        gitTools: 'Git 工具:',
...
const en: typeof zhCN = {
  ...
  init: {
    ...
    pathWarning: 'Claude Code CLI must be available on PATH',
    ...
    mcp: {
      ...
      skipTokenPrompt: 'Skip Token configuration? (run npx ccgs-workflow config mcp later)',
      skipKeyPrompt: 'Skip API Key configuration? (run npx ccgs-workflow config mcp later)',
    ...
    hooks: {
      title: 'Claude monitor hook setup',
      description: 'Use hooks to forward Claude events to the local monitor',
      installed: 'Hook configured (Claude monitor is managing local telemetry)',
    ...
    workflows: {
      dev: 'Primary workflow (/ccgs:spec-impl)',
      frontend: 'OpenSpec init (/ccgs:spec-init)',
      backend: 'Spec research (/ccgs:spec-research)',
      review: 'Acceptance review (/ccgs:spec-review)',
      analyze: 'Execution planning (/ccgs:team-plan)',
      commit: 'Git smart commit (/ccgs:commit)',
      rollback: 'Git rollback (/ccgs:rollback)',
      cleanBranches: 'Clean branches (/ccgs:clean-branches)',
      worktree: 'Worktree management (/ccgs:worktree)',
      init: 'Project initialization (/ccgs:init)',
    },
    aceTool: {
  ...
  menu: {
    ...
    help: {
      title: 'CCG Commands:',
      hint: 'For more information, run: npx ccgs-workflow --help',
      sections: {
    ...
    uninstall: {
      ...
      removedBin: 'Removed legacy runtime files:',
