...
const zhCN = {
  ...
  init: {
    ...
    workflows: {
      dev: '主路径工作流 (/ccg:spec-impl)',
      frontend: 'OpenSpec 初始化 (/ccg:spec-init)',
      backend: '需求研究 (/ccg:spec-research)',
      review: '验收审查 (/ccg:spec-review)',
      analyze: '执行规划 (/ccg:team-plan)',
...
const en: typeof zhCN = {
  ...
  init: {
    ...
    workflows: {
      dev: 'Primary workflow (/ccg:spec-impl)',
      frontend: 'OpenSpec init (/ccg:spec-init)',
      backend: 'Spec research (/ccg:spec-research)',
      review: 'Acceptance review (/ccg:spec-review)',
      analyze: 'Execution planning (/ccg:team-plan)',
