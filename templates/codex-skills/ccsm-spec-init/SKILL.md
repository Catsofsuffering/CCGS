---
name: ccsm-spec-init
description: Start or resume a CCSM change from Codex. Use when you want Codex to own change selection and artifact progression from the first step.
license: MIT
---

Start or resume a CCSM change from Codex.
